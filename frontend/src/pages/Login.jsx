  ...
  return (
    <div className="w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] flex flex-col items-center justify-start">
      ...
      <div className="w-[100%] h-[100px] flex items-center justify-center flex-col gap-[10px]">
        ...
        <span className="text-[16px]">Welcome to One Cart, Place your order</span>
      </div>
      ...
      <div className="max-w-[600px] w-[90%] h-[500px] bg-[#00000025] border-[1px] border-[#96969635] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center">
        <form action="" onSubmit={handleLogin} className="w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]">
          ...
          <div className="w-[90%] h-[400px] relative flex flex-col items-center justify-center gap-[15px]">
            ...
            <p className="flex gap-[10px]">You haven't any account? <span className="text-[#5555f6c5] text-[17px] font-semibold cursor-pointer"
